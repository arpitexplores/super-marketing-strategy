...
5. Rename the extracted folder from `super-marketing-strategy-main` to `super-marketing-strategy`.
6. Copy the renamed `super-marketing-strategy` folder into your agent's skills directory.
...
This repository is the `super-marketing-strategy` skill. Keep the full `super-marketing-strategy` folder together when installing it.
